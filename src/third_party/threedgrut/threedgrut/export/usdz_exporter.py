...
from .nurec_templates import NamedSerialized, fill_3dgut_template
from .usd_util import (
    serialize_nurec_usd,
    serialize_usd_default_layer,
    write_to_usdz,
)
from .normalizing_transform import estimate_normalizing_transform
    ...
    def export(
        ...
        **kwargs,
        ...
        model_file = NamedSerialized(
            filename=output_path.stem + ".nurec", serialized=buffer.getvalue()
        )
